...
void AsciiDevice::generic_description_of_options(std::ostream & o, int mode) const {
...
void AsciiDevice::help_options(std::ostream & o) const {
  o << "\nascii device options:"
    << "\n";
  generic_description_of_options(o,1);
}

void AsciiDevice::generate_file_options(std::ostream & o) const {
  o << "\n[AsciiDevice]"
    << "\n"
