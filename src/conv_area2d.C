...
void
ConvArea2d::set_win_size( int sx,
                          int sy )
{
...
void
ConvArea2d::move_area_dir_x_using_factor( double factor )
{
...
void
ConvArea2d::move_area_dir_y_using_factor( double factor )
{
...
void
ConvArea2d::scale_area_using_factor( double factor )
{
    area.size_x *= factor;
    area.size_y *= factor;
...
void
ConvArea2d::change_area_using_subwin( int origin_x,
                                      int origin_y,
                                      int dest_x,
                                      int dest_y )
{
...
void
ConvArea2d::change_area_using_win_pos( int origin_x,
                                       int origin_y )
{
...
Point2d
ConvArea2d::get_point_from_win_pos( int x,
                                    int y ) const
{
    Point2d pos;
